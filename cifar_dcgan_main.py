...
# train_images_float[0].min(), train_images_float[0].max()
...
train_images_float[0].min(), train_images_float[0].max()
plt.imshow(train_images_float[0].astype('uint8'))
...
#test
# plt.imshow(train_images_float_norm[0])
